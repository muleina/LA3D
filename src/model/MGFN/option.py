...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='MGFN Config')
    ...
    parser.add_argument('--rgb-list', default=f'{current_path}/UCF-crime/ucf-i3d.list', help='list of rgb features ')
    parser.add_argument('--test-rgb-list', default=f'{current_path}/datasets/UCF-crime/ucf-i3d-test.list', help='list of test rgb features ')
    parser.add_argument('--gt', default=f'{current_path}/datasets/UCF-crime/gt-ucf.npy', help='file of ground truth ')
    ...
    parser.add_argument('--seg_length', type=int, default=16, help='default:32') 
