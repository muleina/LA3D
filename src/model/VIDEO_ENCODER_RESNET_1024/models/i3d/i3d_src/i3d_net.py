...
class I3D(torch.nn.Module):
    ...
    def forward(self, inp, features=False):
        ...
        # out = self.avg_pool(out)  # <- [1, 1024, 8 (for T=64) or 3 (for T=24), 1, 1], # error tflite
        out = torch.mean(out, axis=(2,3,4), keepdim=True) # [1, 1024, 1, 1, 1] <- [1, 1024, 2, 7, 7]
